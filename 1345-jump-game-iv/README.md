...
<pre style="position: relative;"><strong>Input:</strong> arr = [100,-23,-23,404,100,23,23,23,3,404]
...
<pre style="position: relative;"><strong>Input:</strong> arr = [7]
...
<pre style="position: relative;"><strong>Input:</strong> arr = [7,6,9,6,9,6,9,7]
